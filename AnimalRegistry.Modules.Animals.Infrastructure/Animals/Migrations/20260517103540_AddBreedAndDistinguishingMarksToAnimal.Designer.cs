...
namespace AnimalRegistry.Modules.Animals.Infrastructure.Animals.Migrations
{
    ...
    [Migration("20260517103540_AddBreedAndDistinguishingMarksToAnimal")]
    partial class AddBreedAndDistinguishingMarksToAnimal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AnimalRegistry.Modules.Animals.Domain.Animals.Animal", b =>
                {
                    ...
                    b.HasIndex("ShelterId", "Species", "Signature")
                        .IsUnique()
